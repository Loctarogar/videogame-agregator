    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                <h2 class="font-semibold text-4xl leading-tight mt-1">FinalFantasy VII Remake</h2>
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <p class="mt-12">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, eaque ipsa quas qui
                        quibusdam sequi voluptatibus. Doloribus eius placeat veniam voluptatum! Amet blanditiis
                        doloribus et facere magni optio sit vitae! Lorem ipsum dolor sit amet, consectetur
                        adipisicing elit. Alias aut corporis debitis distinctio eius facilis fuga illum ipsam
                        maiores molestiae nemo officiis possimus, quaerat quidem quod, soluta totam. Explicabo,
                        in.
                    </p>
                    <div class="mt-12">
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-18">
            <h2 class="h2 text-blue-500 uppercase tracking-wide font-semibold">Images</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                <div class="">
                    <a href="">
                        <img src="/screenshot1.jpg" alt="screenshot" class="hover:opacity-75 transition ease-in-out">
                    </a>
                </div>
                <div class="">
                    <a href="">
        ...
        <div class="similar-games-container  mt-18">
            ...
            >
                <div class="game mt-8">
                    ...
                    <a href="#" class="block text-base font-semibod leading-tight hover:text-gray-400 mt-8">
