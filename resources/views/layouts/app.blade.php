    ...
    <nav class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4 py-6">
        ...
        <div class="flex items-center mt-6 lg:mt-0">
            <div class="relative">
                <input
                    type="text"
                    class="bg-gray-800 text-sm rounded-full focus:outline-none focus:shadow-outline w-46 px-3 pl-8 py-1"
                    placeholder="Search..."
                >
...
<footer class="border-t border-gray-800">
    <div class="container mx-auto px-4 py-6">
        Posered By <a href="#" class="underline hover:text-gray-400">IGDB API</a>
    </div>
